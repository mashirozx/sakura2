...
__This repo is under developement, do not active in production environment!__
 ...
 ### Install
Clone/download into `./wp-content/themes/`, install the must installed plugins ([WPGraphQL](https://github.com/wp-graphql/wp-graphql), [WPGraphQL JWT Authentication](https://github.com/wp-graphql/wp-graphql-jwt-authentication)), then active the theme in WordPress dashboard after compiling.
